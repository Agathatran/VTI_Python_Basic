...
#[DONE]Bài 3: Cho một danh sách các số. Tạo danh sách mới bằng cách bình phương mỗi phần tử của danh sách đó. Ví dụ: numbers = [1, 2, 3, 4, 5, 6, 7] --> [1, 4, 9, 16, 25, 36, 49]
...
#[DONE] Bài 6: Viết chương trình thêm sô 7000 vào sau số 6000 trong Danh sách sau: list1 = [10, 20, [300, 400, [5000, 6000], 500], 30, 40] --> [10, 20, [300, 400, [5000, 6000, 7000], 500], 30, 40]
...
#Bài 7[DONE]: Cho một danh sách lồng nhau. list1 = ["a", "b", ["c", ["d", "e", ["f", "g"], "k"], "l"], "m", "n"]
...
#[DONE]Bài 8: Viết chương trình tìm giá trị 20 trong danh sách, nếu có thì thay bằng 200. Chỉ cập nhật lần xuất hiện đầu tiên của no. Ví dụ: list1 = [5, 10, 15, 20, 25, 50, 20] --> [5, 10, 15, 200, 25, 50, 20]
...
#[DONE]Bài 9: Viết chương trình loại bỏ tất cả các lần xuất hiện của số 20 trong list: Ví dụ: list1 = [5, 20, 15, 20, 25, 50, 20] --> [5, 15, 25, 50]
str=str(input("Input the string: "))
lst=str.split(" ")
for i in range(0,len(lst)):
